...
export const meta = {
  ...
  thumbnail: "/static/img/720px-react_banner.jpg",
  canonical: "https://blog.red-badger.com/2015/03/04/react-native-the-killer-feature-that-nobody-talks-about"
};
...
<iframe width="560" height="315" src="https://www.youtube.com/embed/3wcouW5lXto" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
...
<Codepen hash="RNBVZz" user="robbiemccorkell" preview={false} defaultTab="js,result" />

### React:

<Codepen hash="VYBbyN" user="robbiemccorkell" preview={false} defaultTab="js,result" />
